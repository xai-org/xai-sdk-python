...
class Client(BaseClient):
        ...
        *,
        ...
        async with aiohttp.ClientSession() as session:
            async with session.post(
                ...
                return RestStartResponse(data)

    async def _rest_get(self, request_id: str) -> RestGetResponse:
    ...
    async def _rest_generate(
        ...
        *,
        ...
        start_response = await self._rest_start(
            prompt,
            model,
            image_url=image_url,
            video_url=video_url,
        ...
        # Poll until complete
        while True:
            get_response = await self._rest_get(start_response.request_id)
    ...
    async def get(
        ...
        *,
        ...
        if use_transport == "rest":
            return await self._rest_get(request_id)
