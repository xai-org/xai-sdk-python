...
class CreateCollectionRequest(_message.Message):
    __slots__ = ("team_id", "collection_name", "index_configuration", "chunk_configuration")
    ...
    def __init__(self, team_id: _Optional[str] = ..., collection_name: _Optional[str] = ..., index_configuration: _Optional[_Union[_types_pb2.IndexConfiguration, _Mapping]] = ..., chunk_configuration: _Optional[_Union[_types_pb2.ChunkConfiguration, _Mapping]] = ...) -> None: ...

class CollectionMetadata(_message.Message):
    __slots__ = ("collection_id", "collection_name", "created_at", "index_configuration", "chunk_configuration", "documents_count")
...
class ListCollectionsRequest(_message.Message):
    ...
    def __init__(self, team_id: _Optional[str] = ..., limit: _Optional[int] = ..., order: _Optional[_Union[_shared_pb2.Ordering, str]] = ..., sort_by: _Optional[_Union[CollectionsSortBy, str]] = ..., pagination_token: _Optional[str] = ...) -> None: ...
...
class FileMetadata(_message.Message):
    __slots__ = ("file_id", "name", "size_bytes", "content_type", "created_at", "expires_at", "hash")
    ...
    hash: str
    def __init__(self, file_id: _Optional[str] = ..., name: _Optional[str] = ..., size_bytes: _Optional[int] = ..., content_type: _Optional[str] = ..., created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., expires_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., hash: _Optional[str] = ...) -> None: ...
...
class ListDocumentsRequest(_message.Message):
    __slots__ = ("team_id", "collection_id", "limit", "order", "sort_by", "pagination_token")
    TEAM_ID_FIELD_NUMBER: _ClassVar[int]
    COLLECTION_ID_FIELD_NUMBER: _ClassVar[int]
    LIMIT_FIELD_NUMBER: _ClassVar[int]
    ORDER_FIELD_NUMBER: _ClassVar[int]
    ...
    pagination_token: str
    def __init__(self, team_id: _Optional[str] = ..., collection_id: _Optional[str] = ..., limit: _Optional[int] = ..., order: _Optional[_Union[_shared_pb2.Ordering, str]] = ..., sort_by: _Optional[_Union[DocumentsSortBy, str]] = ..., pagination_token: _Optional[str] = ...) -> None: ...
