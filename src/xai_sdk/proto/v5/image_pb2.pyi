...
class GeneratedImage(_message.Message):
    ...
    storage_error: str
    def __init__(self, base64: _Optional[str] = ..., url: _Optional[str] = ..., up_sampled_prompt: _Optional[str] = ..., respect_moderation: bool = ..., debug_output: _Optional[_Union[GeneratedImageDebugOutput, _Mapping]] = ..., moderation_categories: _Optional[_Iterable[_Union[ModerationCategoryScore, _Mapping]]] = ..., mime_type: _Optional[str] = ..., file_output: _Optional[_Union[FileOutput, _Mapping]] = ..., storage_error: _Optional[str] = ...) -> None: ...
