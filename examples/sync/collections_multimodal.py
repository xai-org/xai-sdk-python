"""Example: multimodal Collections workflow (text + local image path → search → vision chat)."""
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        fields_map = document_fields_by_file_id(
            client.collections,
            collection.collection_id,
            results.matches,
        )
        ...
        client.collections.delete(collection.collection_id)
